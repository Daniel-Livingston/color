...
export type AdjustableColorValues = AdjustableHSLValues | AdjustableHWBValues | AdjustableRGBValues;
...
export type ColorParam = string | CMYKObject | HSLObject | HSVObject | HWBObject | RGBObject;
...
export type ScalableColorValues = ScalableRGBValues | ScalableHSLValues | ScalableHWBValues;
