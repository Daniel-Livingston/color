...
describe('Color()', () => {
	...
	it('should parse an object in the CMYK color space', () => {
		expect(Color({ cyan: 0, magenta: 1, yellow: 0.5, key: 0 }).array).toEqual([0, 1, 0.5, 0]);
	});
	...
	it('should parse an object in the HSL color space', () => {
		expect(Color({ hue: 0, saturation: 1, lightness: 0.5 }).array).toEqual([0, 1, 0.5]);
	});
	...
	it('should parse an object in the HWB color space', () => {
		expect(Color({ hue: 0, whiteness: 0, blackness: 0.5 }).array).toEqual([0, 0, 0.5]);
	});
...
describe('adjust()', () => {
	it('should adjust the color by the given amount (RGB)', () => {
		...
		expect(c.adjust({ red: 255, green: -100, blue: 10 }).array).toEqual([255, 0, 10]);
	});
	...
	it('should adjust the color by the given amount (HSL)', () => {
		...
		expect(c.adjust({ hue: -100, saturation: 0.5 }).array).toEqual([260, 1, 0.5]);
		expect(c.adjust({ hue: 100, saturation: -0.5, lightness: 0.1 }).array).toEqual([100, 0.5, 0.6]);
	});
	...
	it('should adjust the color by the given amount (HWB)', () => {
		...
		expect(c.adjust({ hue: -100, whiteness: 0.5 }).array).toEqual([260, 0.5, 0]);
		expect(c.adjust({ hue: 100, whiteness: -0.5, blackness: 0.1 }).array).toEqual([100, 0, 0.1]);
	});
...
describe('change()', () => {
	it('should change the color to the given amount (RGB)', () => {
		...
		expect(c.change({ red: 255, green: 100, blue: 10 }).array).toEqual([255, 100, 10]);
		expect(Color('#ffffff').change({ red: 0, green: 0, blue: 0 }).array).toEqual([0, 0, 0]);
	});
	...
	it('should change the color to the given amount (HSL)', () => {
		...
		expect(c.change({ hue: 100, saturation: 0.5 }).array).toEqual([100, 0.5, 0.5]);
		expect(c.change({ hue: 100, saturation: 0.5, lightness: 0.1 }).array).toEqual([100, 0.5, 0.1]);
	});
...
describe('complement()', () => {
	it('should return the complement of the color', () => {
		expect(Color({ red: 255, green: 0, blue: 0 }).complement().array).toEqual([0, 255, 255]);
		expect(Color({ red: 0, green: 255, blue: 0 }).complement().array).toEqual([255, 0, 255]);
		expect(Color({ red: 0, green: 0, blue: 255 }).complement().array).toEqual([255, 255, 0]);
		expect(Color({ hue: 0, saturation: 1, lightness: 0.5 }).complement().array).toEqual([
			180, 1, 0.5
		]);
		expect(Color({ hue: 180, saturation: 1, lightness: 0.5 }).complement().array).toEqual([
			0, 1, 0.5
		]);
		expect(Color({ hue: 60, saturation: 0.5, lightness: 1 }).complement().array).toEqual([
			240, 0.5, 1
		]);
	});
});
...
describe('grayscale()', () => {
	it('should return the grayscale version of the color', () => {
		expect(Color({ hue: 180, saturation: 1, lightness: 0.5 }).grayscale().array).toEqual([
			0, 0, 0.5
		]);
		expect(Color({ hue: 60, saturation: 0.5, lightness: 1 }).grayscale().array).toEqual([0, 0, 1]);
	});
});

describe('invert()', () => {
	it('should return the inverse of the color', () => {
		expect(Color({ red: 255, green: 0, blue: 0 }).invert().array).toEqual([0, 255, 255]);
		expect(Color({ red: 0, green: 255, blue: 0 }).invert().array).toEqual([255, 0, 255]);
		expect(Color({ red: 0, green: 0, blue: 255 }).invert().array).toEqual([255, 255, 0]);
...
describe('scale()', () => {
	it('should scale the color by the given amount (RGB)', () => {
		expect(Color('#6b717f').scale({ red: 3, blue: 10, green: 5 }).hex).toBe('#ffffff');
		expect(Color('#6b717f').scale({ red: -10, green: -5, blue: -1 }).hex).toBe('#000000');
		expect(Color('#6b717f').scale({ red: -0.15, green: 0.8, blue: -0.3 }).hex).toBe('#5be359');
	});
	...
	it('should scale the color by the given amount (HSL)', () => {
		...
		expect(Color('#6b717f').scale({ saturation: 0.8, lightness: -0.3 }).hex).toBe('#0f3795');
	});
	...
	it('should scale the color by the given amount (HWB)', () => {
		...
		expect(Color('#6b717f').scale({ whiteness: 0.8, blackness: -0.3 }).hex).toBe('#b7b7b7');
	});
});
